    ...
    <div class="card-body msg_card_body">
        <div v-for="message in messages" :key="message.id">
            <div v-if="idSender === message.idSender">
                <div v-for="message in orderMessages(message.messages)" :key="message.id"
                    class="d-flex justify-content-end mb-4">
                    <div class="msg_cotainer_send" v-html="message">
                    </div>
                    <div class="img_cont_msg">
                        <img :src="mixAssetUrl + '/images/gOr7e1Qaxlh89FlAKz3t.jpg'" class="rounded-circle user_img_msg">
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        if (vm.history_messages.length > 0)
            vm.history_messages.forEach(element => {
                //console.log(element)
        ...
        this.emitter.on('messagesSendBot', (messageWriteBot) => {
            ...
            vm.idSender = messageWriteBot.sessionId
